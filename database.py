...
def insert_CSV_data(table_name, conn): # opens respective csv file and inserts data into correct table
    ...
    for i in range(len(rows)):
        ...
        try:
            cursor.execute(sql_query, record)  # the execute method will fill in each record value into the sql_query string            
    ...
    print("number of rows affected for " + table_name +" table:", rows_affected_count) # prints how many rows were inserted per table
    cursor.close()
